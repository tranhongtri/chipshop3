                        ...
                        <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
                            <div className="widget about-widget">
                                <div className="logo widget-title">
                                    <Link onClick={ClickHandler} href="/"><img src='/images/logo.png' alt="ft-logo" /> Annahl</Link>
                                </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col col-xs-12">
                            <p className="copyright"> Copyright &copy; 2022 Annahl by <Link onClick={ClickHandler} href="/">themepresss</Link>.
